...
export default function Tracker() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    // Case-insensitive match. `.ilike` handles upper/lower automatically.
    const { data, error } = await supabase
      .from('applications')
      .select('*')
    ...
    // Load messages for the found app (needed for the admin message banner)
    ...
    // Load status history for the found app
