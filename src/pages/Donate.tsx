        ...
        <section className="section-padding bg-white">
          <div className="container-max max-w-2xl">
            <div className="card p-8 text-center">
              ...
              <div className="mt-6 rounded-lg bg-primary-50 p-5 text-left">
                <p className="text-sm font-bold uppercase tracking-wider text-primary-700">
                  Next Step
                </p>
                <p className="mt-3 text-sm leading-relaxed text-neutral-700">
                  We are grateful to receive your donation request. Every dollar donated makes a meaningful difference and helps support our mission.
                </p>
                <p className="mt-3 text-sm leading-relaxed text-neutral-700">
                  Our team will contact you with the payment details and instructions for your selected payment method.
                </p>
                <p className="mt-3 text-sm leading-relaxed text-neutral-700">
                  Thank you for your generosity and for supporting our work.
                </p>
              </div>
            ...
            <div className="lg:col-span-3">
              <form onSubmit={handleSubmit} className="card p-8">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-xs text-neutral-500">
                  ...
                  Secure donation · Tax-deductible · Tax ID: 01-0686174
                </div>
              </form>
            </div>
