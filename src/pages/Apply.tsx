...
/**
 * Generate a random reference number in the format HCF-abc-123456
 * - HCF is constant
 * - abc = 3 random lowercase letters
...
/**
 * Check if a birth date makes the applicant at least 18 years old.
 */
...
export default function Apply() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Attempt insert with a client-generated reference.
    // Retry up to 3 times in the (extremely unlikely) case of a UNIQUE collision.
    ...
    while (attempt < MAX_ATTEMPTS && !insertedData) {
      ...
      try {
        ...
        if (insertError) {
          ...
          // If it's not a uniqueness conflict, don't bother retrying.
            ...
            <div>
              ...
              <div className="mt-5 grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-neutral-400">You must be 18 years or older to apply</p>
                </div>
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-neutral-700">
                    Country *
